...
var _this = this;
var REQUEST_CHINA = 'https://www.techinasia.com/wp-json/techinasia/2.0/categories/e-commerce-social-commerce/posts';
          ...
          <View style={styles.container}>
            <View style={styles.topWrapper}> 
              ...
              <View style={styles.rightTop}>
                ...
                <Text style={styles.date}>{posts.date_gmt}</Text>
              </View>
            </View>
