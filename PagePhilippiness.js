...
var _this = this;
var REQUEST_MALAYSIA= 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/philippines/posts';

export class PagePhilippiness extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
        ...
        <View>
          <View style={styles.container}>
            <View style={styles.topWrapper}> 
              <Image 
                source={{uri: posts.author.author_url}} 
            ...
            <View style={styles.rightContainer}>
              <TouchableHighlight style={styles.listviews} onPress={() => this.showBookDetail(posts)}  underlayColor='#dddddd'>
                <Text style={styles.title} numberOfLines={3}>{posts.title}</Text>
              </TouchableHighlight>
              <Text style={styles.descWrap} numberOfLines={3}>
...
module.exports = PagePhilippiness;