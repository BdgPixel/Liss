...
var _this = this;
var REQUEST_INDONESIA = 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/indonesia/posts';

export class PageIndonesia extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
