...
var _this = this;
var REQUEST_MALAYSIA= 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/taiwan/posts';

export class PageTaiwan extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
