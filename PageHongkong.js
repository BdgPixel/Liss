...
var _this = this;
var REQUEST_HONGKONG = 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/hongkong/posts';

export class PageHongkong extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
