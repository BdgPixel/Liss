...
var _this = this;
var REQUEST_URL = 'https://www.techinasia.com/wp-json/techinasia/2.0/posts';
        ...
        <View>
          <View style={styles.container}>
            ...
            <View style={styles.rightContainer}>
              <TouchableHighlight style={styles.listviews} onPress={() => this.showBookDetail(posts)}  underlayColor='#fcfcfc'>
              ...
              <View style={styles.bottomContent}>
                ...
                <View style={styles.containerBottom}>
                  <View style={styles.textWrap}>
                    <Text style={styles.textDet2}>{posts.read_time} Read Time</Text>
                  </View>
