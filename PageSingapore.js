...
var _this = this;
var REQUEST_MALAYSIA= 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/singapore/posts';

export class PageSingapore extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
