...
var _this = this;
var REQUEST_MALAYSIA= 'https://www.techinasia.com/wp-json/techinasia/2.0/tags/thailand/posts';

export class PageThailand extends Component{
  constructor(props){
    super(props);
    this.state ={
      isLoading: true,
